...
config.company.origin.url = process.env.COMPANY_ORIGIN_URL || 'https://app.zahironline.com'
...
config.company.destination = {}
config.company.destination.url = process.env.COMPANY_DESTINATION_URL || 'https://app.zahironline.com'
